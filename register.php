...
if (isset($_POST['sub'])) {
	...
	if($pass===$pass2){
        if(strlen($pass)>=6){
             $newPass=sha1("uhb".$pass);
             $user=new User();
             $addUser=$user->register($email,$newPass);
             if($addUser==="done"){
		...
		$msg="<div class=alert alert-danger>ddd</div>";
		echo "string";
	}
		...
		<div class="row">
			...
			<div class="col-12 col-sm-12 ">
				...
				<form class="forms" method="POST">
					...
					<div class="form-group ">
						<div class="col-sm-12 col-md-4">
							<input type="password" name="pass2" class="form-control" placeholder="اعادة كلمة المرور ">
						</div>
					</div>

					<div class="form-group row">
						<div class="col-sm-6 col-md-4">
							<input type="submit" name="sub" class="btn btn-info btn-block" value="تسجيل  ">
